 ...
 *
 * Disassembly of SSDT-5-ACRPRDCT.aml, Sun Feb  9 19:43:19 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00004556 (17750)
 *     Revision         0x01
 *     Checksum         0x22
 *     OEM ID           "ACRSYS"
...
DefinitionBlock ("", "SSDT", 1, "ACRSYS", "ACRPRDCT", 0x00001000)
{
    ...
    External (HLRS, IntObj)    // (from opcode)
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x7AE16018, 0x00040004)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (SGOP, SystemMemory, 0x7A78D018, 0x00000046)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (NOPR, SystemMemory, 0x7AE13018, 0x00002010)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store ("<<< GC6O >>>", Debug)
            While (LNotEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0x81010011), One))
            {
                Sleep (One)
            }

            Store (Zero, LNKD)
            \_SB.PCI0.PEG0.PEGP.SGPO (0x8102000A, Zero)
            While (LNotEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0x81010011), Zero))
            {
                Sleep (One)
            }

            \_SB.PCI0.PEG0.PEGP.SGPO (0x8102000A, One)
        ...
        {
            If (LEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0x81010011), Zero))
            {
                Return (One)
            }
            ElseIf (LEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0x81010011), One))
            {
                Return (0x03)
            }
        }
