 ...
 *
 * Disassembly of SSDT-13-ACRPRDCT.aml, Sun Feb  9 19:43:19 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "ACRSYS", "ACRPRDCT", 0x00001000)
{
    ...
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            {
                CreateDWordField (CRS, \_SB.TPM._Y39._BAS, CBAS)  // _BAS: Base Address
                Store (PTTB, CBAS)
                Store (PTTB, PTTA)
                Return (CRS)
            }
            ...
            OperationRegion (TNVS, SystemMemory, 0x7AE6F000, 0x26)
